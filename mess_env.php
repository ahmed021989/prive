							...
							foreach($messaages as $message){
								...
								?>
										 ...
										 <td> <?php  if ($personne = Personne:: trouve_par_id($message-> id_destinataire)) {
											...
											<td><span style="color:red"><?php echo html_entity_decode($message->objet); ?></a></td>
										     <td ><span style="color:green"><?php echo  html_entity_decode($message->dat_env); ?></span></td>
											<td><span style="color:red"><?php echo html_entity_decode($message->message); ?></td>
