...
$query3="select * from dossier_accept,condidat  where dossier_accept.code=condidat.code and  accept='non' and grade='".$_POST['select_refuse']."'";
...
$htmlpersian.='<h2 style="text-align:right"><u>ملفات الترشح المرفوضة</u></h2><br>';
...
//}
 ...
 header("Location: ../../administration/list_refuse.php");		
}
// ---------------------------------------------------------
ob_end_clean();
//Close and output PDF document
$pdf->Output('liste_refuse.pdf', 'I');
