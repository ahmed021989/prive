...
*/
$fileName = 'backup-SIRH--' . date("Y")."-".date("m")."-".date("d") . '@'.date('H.i.s').'.sql' ; 
...
$return .= "--\n";
$return .= '-- Export created: ' . date("Y")."-".date("m")."-".date("d"). ' on ' . date("H:i") . "\n\n\n";
$return = "--\n";
...
{ 
    ...
    { 
        ...
        {   
        $return .= '"'.$mysqli->real_escape_string(html_entity_decode($rowdata[$i])) . "\"," ;
        }
