...
global $bd;
    ...
    $bd->requete('insert into cpt_connectes (ip, timestamp,user,session) values ("'.$_SERVER['REMOTE_ADDR'].'", "'.time().'","'.$user->login.'","'.$this->session_id.'")');
  ...
  public function logout($user) {
	...
	//session_destroy();
	$bd->requete("delete from cpt_connectes where user ='".$user->login."' and session='".$this->session_id."'");
  }
