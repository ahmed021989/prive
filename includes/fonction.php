...
class Fonction {
	...
	protected static $nom_table="fonction";
	protected static $champs = array('id_fonc', 'nom_fonc');
	public $id_fonc;
	public $nom_fonc;
  ...
  public function nom_compler() {
	...
	public  function  existe(){
	 global $bd;
	 $sql  = "SELECT * FROM ".self::$nom_table." ";
    $sql .= "WHERE nom_fonc = '".$this->nom_fonc."' ";
  ...
  public static function trouve_par_id($id) {
    $result_array = self::trouve_par_sql("SELECT * FROM ".self::$nom_table." WHERE id_fonc ={$id} limit 1");
		return !empty($result_array) ? array_shift($result_array) : false;
  }
  ...
  public static function trouve_par_sql($sql="") {
	...
	*/
	...
	public function save(){
	 ...
	 return isset($this->id_fonc)? $this->modifier() : $this->ajouter();
	}
...
$sql .= " WHERE id_fonc =". $bd->escape_value($this->id_fonc) ;
$bd->requete($sql);
