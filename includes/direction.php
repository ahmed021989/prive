...
class Direction {
	...
	protected static $nom_table="direction";
	protected static $champs = array('Id_derc', 'Nom_derc_ar', 'Nom_derc_fr','Add_derc_ar','Add_derc_fr','Num_tele_der','Num_fax');
	public $Id_derc;
	public $Nom_derc_ar;
	public $Nom_derc_fr;
	public $Add_derc_ar;
  ...
  public function nom_compler() {
	...
	public  function  existe(){
	 global $bd;
	 $sql  = "SELECT * FROM ".self::$nom_table." ";
    $sql .= "WHERE Nom_derc_ar = '".$this->Nom_derc_ar."' ";
  ...
  public static function trouve_par_id($id) {
    $result_array = self::trouve_par_sql("SELECT * FROM ".self::$nom_table." WHERE Id_derc ={$id} LIMIT 1");
		return !empty($result_array) ? array_shift($result_array) : false;
  }
  ...
  public static function trouve_par_sql($sql="") {
	...
	*/
	...
	public function save(){
	 ...
	 return isset($this->Id_derc)? $this->modifier() : $this->ajouter();
	}
...
$sql .= " WHERE Id_derc =". $bd->escape_value($this->Id_derc) ;
$bd->requete($sql);
