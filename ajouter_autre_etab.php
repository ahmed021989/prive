...
?>
         ...
         <!-- START BREADCRUMB -->
                ...
                <div class="page-title"  >                    
                    <h2><span class="fa fa-briefcase"></span>  Ajouter Type Etablissement </h2>
                </div>   
                            ...
                            <div class="panel panel-default">
                                <div class="panel-heading">
                                    ...
                                    <ul class="panel-controls">
                                        <li> <h3 class="panel-title"><strong> Information sur Type Etablissement </strong></h3></li>
                                    </ul>
                                </div>
                                ...
                                <div class="panel-body">                                                                        
                                    ...
                                    <div class="form-group"  style = "text-align: right;">
									 <label class="col-md-3 col-xs-12 control-label"> Type Etablissement : </label>
                                ...
                                <div class="panel-footer">
                                    ...
                                    <a href="ajouter_employe.php" class="btn btn-danger pull-right" >Retour</a> 
